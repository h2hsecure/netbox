...
export CHALLENGE_HMAC_KEY="${CHALLENGE_HMAC_KEY:-A123B456C789}"

export BACKEND_LOGO="${BACKEND_LOGO:-/favicon.ico}"
export TOKEN_DURATION="${TOKEN_DURATION:-12h}"
export COOKIE_DURATION="${COOKIE_DURATION:-43800h}"
export COOKIE_NAME="${COOKIE_NAME:-_ntb_proto}"
export TOKEN_SECRET="${TOKEN_SECRET:-$(echo $RANDOM | md5sum | head -c 20)}"
